            ...
            <div key={task._id} className="rounded-xl border border-sky-200 bg-sky-50/50 p-4 space-y-3">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs font-bold text-neutral-900">{task.title}</p>
                </div>
                <button
                  type="button"
                  onClick={() => openReviewModal(task)}
                  className="inline-flex items-center gap-1.5 rounded-lg bg-sky-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-sky-700 transition shrink-0"
                >
              ...
              {task.notes && (
                <p className="text-xs text-neutral-600 bg-white/80 rounded-lg p-2.5 border border-sky-100 leading-relaxed">
                  {task.notes}
                </p>
              )}
            </div>
