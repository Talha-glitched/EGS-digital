...
export default function OngoingJobStageEditorModal({ open, onClose, stages = [], onSaved }) {
  ...
  return (
    <Modal
      ...
      title="Ongoing Jobs stages"
      subtitle="Customize the job stages that appear on your Ongoing Jobs board."
      size="lg"
      icon={Settings2}
      accent="brand"
      footer={(
