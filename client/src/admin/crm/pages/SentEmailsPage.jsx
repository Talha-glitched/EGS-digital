...
import { crmApiFetch, fetchSendDeliveryIssues, fetchSentEmails } from '../crmApi.js';
...
export default function SentEmailsPage() {
  ...
  useEffect(() => {
    setPage(1);
  }, [campaignId, debouncedSearch, repliedOnly, view]);
  ...
  }, [page, campaignId, debouncedSearch, repliedOnly, view]);
