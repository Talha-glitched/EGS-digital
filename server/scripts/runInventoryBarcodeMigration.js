...
try { await pool.query(await fs.readFile(path.join(scriptDir, '16_inventory_barcode.sql'), 'utf8')); console.log('Inventory and barcode migration applied successfully.'); } finally { await pool.end(); }
