...
try { await pool.query(await fs.readFile(path.join(scriptDir, '20_employee_operations.sql'), 'utf8')); console.log('Employee operations migration applied successfully.'); } finally { await pool.end(); }
