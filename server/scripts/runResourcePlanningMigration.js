...
try { await pool.query(await fs.readFile(path.join(scriptDir, '22_resource_planning.sql'), 'utf8')); console.log('Resource planning migration applied successfully.'); } finally { await pool.end(); }
