...
try {
  await pool.query(await fs.readFile(path.join(scriptDir, '13_production_execution.sql'), 'utf8'));
  console.log('Production execution migration applied successfully.');
