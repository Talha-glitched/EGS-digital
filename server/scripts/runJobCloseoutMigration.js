...
try { await pool.query(await fs.readFile(path.join(scriptDir, '17_job_closeout.sql'), 'utf8')); console.log('Job closeout migration applied successfully.'); } finally { await pool.end(); }
