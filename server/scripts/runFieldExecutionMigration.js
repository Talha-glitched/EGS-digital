...
try { await pool.query(await fs.readFile(path.join(scriptDir, '24_field_execution.sql'), 'utf8')); console.log('Field execution migration applied successfully.'); } finally { await pool.end(); }
