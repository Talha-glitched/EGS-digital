...
try { await pool.query(await fs.readFile(path.join(scriptDir, '18_job_costing.sql'), 'utf8')); console.log('Job costing migration applied successfully.'); } finally { await pool.end(); }
