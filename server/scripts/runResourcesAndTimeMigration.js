...
try {
  await pool.query(await fs.readFile(path.join(scriptDir, '15_resources_and_project_time.sql'), 'utf8'));
  console.log('Resources and project time migration applied successfully.');
