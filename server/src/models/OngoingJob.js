...
export const ONGOING_JOB_STAGES = DEFAULT_PIPELINE_STAGES.map((stage) => stage.name);
export const OPPORTUNITY_STAGES = ONGOING_JOB_STAGES;
...
export const OngoingJob =
  ...
  mongoose.model('OngoingJob', ongoingJobSchema, 'opportunities');

export const Opportunity = OngoingJob;
